...
def crop_img(tensor, target, tensor):
...
class UNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.max_pool__2x2 = nn.MaxPool(kernel_size=2, stride=2)
        ...
        self.up_trans_1 = nn.COnv_Transpose2d(
            in_channels=1024,
            out_channels=512,
            kernel_size=2,
            stride=2
        ...
        self.up_trans_2 = nn.COnv_Transpose2d(
            in_channels=512,
            out_channels=256,
            kernel_size=2,
            stride=2
        ...
        self.up_trans_3 = nn.COnv_Transpose2d(
            in_channels=256,
            out_channels=128,
            kernel_size=2,
            stride=2
        ...
        self.up_trans_4 = nn.COnv_Transpose2d(
            in_channels=128,
            out_channels=64,
            kernel_size=2,
            stride=2
